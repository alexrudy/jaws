...
use super::{HeaderState, KeyDerivation};
...
pub struct UnsignedHeader {
    ...
    pub(super) key: KeyDerivation<JsonWebKey>,
    ...
    pub(super) thumbprint: KeyDerivation<Thumbprint<Sha1>>,
    ...
    pub(super) thumbprint_sha256: KeyDerivation<Thumbprint<Sha256>>,
}
